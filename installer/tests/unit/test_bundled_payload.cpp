...
void TestBundledPayload::onDeviceScriptsAreAllExtracted() {
    ...
    // The expected set per installer.qrc /on-device/ (10 items  -  home-tile
    // revision adds install-home-tile.sh).
    const QStringList expectedBasenames = {
        ...
        QStringLiteral("install-persistence.sh"),
        ...
        QStringLiteral("xovi-activate.service"),
        QStringLiteral("xovi-activate.sh"),
    };
