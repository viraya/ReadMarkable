...
constexpr const char* kStock = R"({
  ...
  "rootfs_mount": "ro",
  "xovi":  {"installed": false, "tag": "", "install_source": "", "path": "/home/root/xovi", "trigger_installed": false},
...
constexpr const char* kXoviOnly = R"({
  ...
  "firmware": "20260310084634",
  "rootfs_mount": "ro",
  "xovi":  {"installed": true, "tag": "v18-23032026", "install_source": "readmarkable-installer", "path": "/home/root/xovi", "trigger_installed": true},
...
void TestDeviceState::parsesXoviOnlyNoRm() {
    ...
    QVERIFY(s->xovi.triggerInstalled);
    QVERIFY(s->appload.installed);
    QVERIFY(!s->readmarkable.installed);
}
